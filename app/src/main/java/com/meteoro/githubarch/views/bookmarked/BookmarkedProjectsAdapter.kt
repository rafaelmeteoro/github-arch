...
class BookmarkedProjectsAdapter @Inject constructor() : RecyclerView.Adapter<BookmarkedProjectsAdapter.ViewHolder>() {

    var projectsList: List<ProjectUI> = arrayListOf()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_bookmarked_projects, parent, false)
        return ViewHolder(itemView)
    }

    override fun getItemCount(): Int = projectsList.count()
